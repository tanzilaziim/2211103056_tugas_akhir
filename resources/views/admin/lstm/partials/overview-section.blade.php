            ...
            <div class="grid grid-cols-1 divide-y divide-surface-200 lg:grid-cols-2 lg:divide-x lg:divide-y-0">
                <div class="p-7">
                    <div class="flex flex-col gap-6">
                        ...
                        <button type="button" data-start-prediction class="inline-flex w-full items-center justify-center gap-2 rounded-full bg-primary-300 py-2.5 text-base text-surface-50 transition-colors hover:bg-primary-400">
        ...
        <div class="rounded-[15px] border border-surface-200 bg-surface-100 shadow-sm">
            <div class="px-7 pb-5 pt-7">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        <div class="inline-flex items-center rounded-full border border-primary-300 bg-surface-100 p-[3px]">
                            <button data-table-range="24jam" class="rounded-full bg-primary-300 px-4 py-1.5 text-sm text-surface-50">24 Jam</button>
                            <button data-table-range="7hari" class="rounded-full px-4 py-1.5 text-sm text-surface-300 hover:text-primary-300">7 Hari</button>
                            <button data-table-range="30hari" class="rounded-full px-4 py-1.5 text-sm text-surface-300 hover:text-primary-300">30 Hari</button>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <div data-date-menu="table" class="absolute right-0 top-full z-20 mt-2 hidden w-64 rounded-xl border border-surface-200 bg-surface-100 p-3 shadow-lg">
                                <div data-date-mode="single" data-date-scope="table">
                                    <div class="mb-2 flex items-center justify-between">
                                        <button type="button" data-date-prev="table" class="rounded-lg p-1 hover:bg-surface-200">
                                            <i class="ph ph-caret-left text-base text-surface-300"></i>
                                        </button>
                                        <span data-date-current="table" class="text-sm font-medium text-surface-300"></span>
                                        <button type="button" data-date-next="table" class="rounded-lg p-1 hover:bg-surface-200">
                                            <i class="ph ph-caret-right text-base text-surface-300"></i>
                                        </button>
                                    </div>
                                    <div data-date-list="table" class="max-h-48 space-y-1 overflow-y-auto"></div>
                                </div>
