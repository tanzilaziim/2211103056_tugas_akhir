...
<div class="mb-8 grid grid-cols-1 gap-5 md:grid-cols-2 2xl:grid-cols-4">
    <div class="rounded-[15px] border border-surface-200 bg-surface-100 px-4 py-4 shadow-sm">
        ...
        <span class="text-4xl font-normal text-surface-300">40.824</span>
    </div>
    ...
    <div class="rounded-[15px] border border-surface-200 bg-surface-100 px-4 py-4 shadow-sm">
        ...
        <div class="mt-1 space-y-1 text-base text-surface-300">
            <div class="flex gap-2"><span class="w-10">Start</span><span>:</span><span>01-01-2025</span></div>
            <div class="flex gap-2"><span class="w-10">End</span><span>:</span><span>30-12-2025</span></div>
        </div>
    </div>
    ...
    <div class="rounded-[15px] border border-surface-200 bg-surface-100 px-4 py-4 shadow-sm">
        ...
        <div class="mt-1 space-y-1 text-base text-surface-300">
            <div class="flex gap-2"><span class="w-16">Missing</span><span>:</span><span>231</span></div>
            <div class="flex gap-2"><span class="w-16">Duplikat</span><span>:</span><span>121</span></div>
        </div>
    </div>
